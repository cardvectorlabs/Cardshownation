...
import { useEditorStore, selectTables, selectRows } from '@floorplanner/store/index'
import { rowModule } from '@floorplanner/domain/rows.impl'
import { formatDimension, formatTableSize } from '@floorplanner/lib/units'
import type { TableId, RowId } from '@floorplanner/domain/types'
